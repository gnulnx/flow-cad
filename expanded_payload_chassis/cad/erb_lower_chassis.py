...
class ChassisParams:
    ...
    front_rear_panel_height: float = 234.0
    ...
    shelf_z_levels: tuple[float, float] = (92.0, 146.0)
...
def write_report(parts: dict[str, object], exported: list[Path]) -> Path:
    ...
    lines.extend(
        [
            ...
            f"- The {P.center_box_outer_width:.0f} mm center_box_outer_width is the structural side-plate outside-to-outside width; axle inserts are recessed flush into the side plates.",
